...
//   |  |  |  |    |   |   |    |  |    |     |   |  |  |  |   |    |     |   |   |     |                          |
    ...
    { 3,7 ,14, 2,1152,LO, 240, 2,ALL,TRIAN, 600, 7, 1, 2, 4, 960, NOISE,  0,  0,  0,"Shakuhachi"},              // 77
    ...
    { 2, 9, 0, 0, 704,LO, 592, 5,ALL,PULSE, 600, 0, 9, 0, 0, 640, SAWTH,  0,  0,  0,"Lead 4 (chiff)"},          // 83
    ...
    { 1, 8, 0,1 , 0  ,LO, 300, 0,NON,SAWTH,   0, 0, 0, 0, 0,   0, NONE ,  0,  0,  0,"Sitar"},                  // 103
    { 1, 7, 0,1 , 0  ,LO, 245, 0,NON,SAWTH, 600, 0, 6, 0, 1,   0, SAWTH,  0,  0,  0,"Banjo"},                  // 104
